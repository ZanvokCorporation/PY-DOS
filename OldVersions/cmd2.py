...
while command != "quit":
	...
	if command == "credits":
		...
		print("Updated version of PY-DOS 1.00")
		print("Build number: 2021.6.216")
		print("Build version: JN2021")
	elif command == "chat":
		print("Hello! " + first_name +  " " + last_name + "😀")
		print("Welcome to PY-DOS Chat  {Beta}")
		...
		if chat_1 == sad_var:
			...
			if bored_sol == yes_var:
				print("Well, you can play games, watch movies, or find out  secret codes in PY-DOS!!")
